...
namespace AeroTripProject.WebUI.Areas.Admin.ViewComponents.AdminDashboard
{
    public class AdminDashboardCard1ViewComponent:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var TurResponsemessage=await client.GetAsync("https://localhost:7051/api/Destinations/Count");
            var QonaqResponsemessage =await client.GetAsync("https://localhost:7051/api/Users/GetUserListCount");
